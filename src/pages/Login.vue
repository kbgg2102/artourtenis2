        ...
        <div class="max-w-screen-xl m-0 sm:m-20 bg-white shadow sm:rounded-lg flex justify-center flex-1">
            <div class="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
                <div class="image-container">
                    ...
                    <img :src="logoartour" alt="Logo Artour">
                </div>
            ...
            <div class="flex-1 bg-indigo-100 text-center hidden lg:flex">
                <div class="m-12 xl:m-16 w-full bg-contain bg-center bg-no-repeat" :style="backgroundImageStyle">
...
img {
    max-width: 100%;
    /* Opcional: para asegurar que la imagen no sea más ancha que su contenedor */
    height: auto;
    /* Opcional: para mantener la proporción de la imagen */
}
</style>